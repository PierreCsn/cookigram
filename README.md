...
| **v2** | **Cooking Copilot** | ✅ **Livré (v2.0)** | **Le copilote du plan de travail** : Étape 0 de mise en place & découpes, mode cuisine lisible à 1 mètre, minuteurs wall-clock persistants avec alarme Web Audio & vibrations, sticky bar contextuelle, synthèse et commandes vocales mains-libres, profil sensoriel et reconnaissance des ustensiles. |
